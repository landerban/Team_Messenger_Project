...
class CustomUserManager(BaseUserManager):
    def create_user(self, email=None, password=None, user_id=None, first_name=None, last_name=None, **extra_fields):
        if not email:
    ...
    def create_superuser(self, email=None, password=None, user_id=None, first_name=None, last_name=None, **extra_fields):
        ...
        return self.create_user(email=email, password=password, user_id=user_id, first_name=first_name, last_name=last_name, **extra_fields)
